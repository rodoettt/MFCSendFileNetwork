...
// MFCSendFilesNetwork.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCSendFilesNetworkApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCSendFilesNetworkApp

CMFCSendFilesNetworkApp::CMFCSendFilesNetworkApp()
{
...
// Единственный объект CMFCSendFilesNetworkApp

CMFCSendFilesNetworkApp theApp;


// Инициализация CMFCSendFilesNetworkApp

BOOL CMFCSendFilesNetworkApp::InitInstance()
{
	...
	if (!AfxSocketInit())
	{
		AfxMessageBox(L"Ошибка инициализации сокета!");
		return FALSE;
	}
